...
class SmallCarTest {
	/**
	 * fields for objects of class SmallCarTest
	 */
	...
	void testGetCurrentFuel() {
		...
		testCar.drive(200);
		assertEquals(testCar.getCurrentFuel(), 39);
	}
